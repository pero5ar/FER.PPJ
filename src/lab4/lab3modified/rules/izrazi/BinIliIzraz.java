...
public class BinIliIzraz extends BoilerplateIzraz {
    public BinIliIzraz() {
        super("<bin_ili_izraz>", Rules.BIN_XILI_IZRAZ.symbol);
    }
    ...
    protected void check2(Scope scope, SemanticNode node) {
        ...
        if(node.getChildren().size()==3) {
                InstructionGenerator.bitor(scope, cNameFirst, cNameSecond);
